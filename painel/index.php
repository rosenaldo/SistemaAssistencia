			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php">dialogaTech<span class="dashboard_text"></span></a></h1>
					</div>
...
<!-- junior -->
							...
							<li class="treeview <?php echo $orcamentos ?>">
								<a href="orcamentos">
									<i class="fa fa-pencil"></i> <span>Nova Venda</span>
								</a>
							</li>
