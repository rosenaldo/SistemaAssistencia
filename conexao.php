...
/*
$servidor = 'localhost';
$banco = 'junior75_assistec';
$usuario = 'junior75_assistec';
$senha = 'senhaprojeto';
*/
try {
...
if($url[1] == 'localhost/'){
	$url_sistema = "http://$_SERVER[HTTP_HOST]/assistencia/";
}

// TODO: variaveis globais
$nome_sistema = 'ConnectPhone';
$email_sistema = 'joserdasjunior.com';
